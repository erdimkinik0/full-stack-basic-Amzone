          ...
          data.map((product) => {
            return <div className="slider-container">
              ...
              <div className="d-flex justify-content-around products-cont">
                ...
                <p style={{fontSize:"16px"}}>{product.name.slice(0, 10)}...</p>
                <span>
                  <input onChange={props.onQuantityChangeHandler} style={{color:"rgb(122, 119, 119)", width: "30px", height: "30px",background:"transparent",border:"none",textAlign:"center",fontWeight:"600",fontSize:"14px"}} type="number" defaultValue={0} />
                  <button onClick={(e) => {
                    e.preventDefault()
