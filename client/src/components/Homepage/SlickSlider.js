          ...
          data.map((product) => {
            return <div className="slider-container">
              ...
              <div className="d-flex justify-content-around products-cont">
                ...
                <span>
                  <input style={{ width: "30px", height: "30px",background:"transparent",border:"none",textAlign:"center",fontWeight:"600"}} type="number" defaultValue={0} />
                  <button style={{padding:"0%"}}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-bag-plus-fill" viewBox="0 0 16 16">
