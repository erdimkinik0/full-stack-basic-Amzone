                    ...
                    <div className="carousel-item caro-1 active">
                        <div className="caro-1-content">
                            <h5>Shop Computers <br></br>
                                & Accessories</h5>
                            <button>See more<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-arrow-right-short" viewBox="0 0 16 16">
                        ...
                        <div className="caro-2-content ">
                            <div className="row">
                                ...
                                <div className="col-md-5">
                                    ...
                                    <button>See now<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-arrow-right-short" viewBox="0 0 16 16">
                                        <path fillRule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
                                    </svg></button>
                                </div>
                            </div>
